...
import QisAPI.{AsiEXT, LoginEXT, OverviewEXT}
...
case class QisAPI private (private val loginFormParams: Seq[(String, String)]):
...
object QisAPI:
  ...
  def apply(username: String, pwd: String): QisAPI = new QisAPI(Seq("asdf" -> username, "fdsa" -> pwd))
